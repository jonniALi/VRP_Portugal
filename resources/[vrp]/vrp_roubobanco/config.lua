...
Config.BankRobbery = {
    [1] = {
        ...
        Doors = { 
            ...
            {Coords = vector3(261.36, 215.67, 101.68), Object = "hei_v_ilev_bk_safegate_pris", Heading = -110.0, WeldPosition = {C = vector3(261.25, 216.03, 100.68), H = 254.73}, Time = 2, Frozen = false},
